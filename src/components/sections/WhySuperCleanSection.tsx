  ...
  return (
    <section className="relative w-full bg-white border-b border-[#EBEBEB] overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[680px]">
        ...
        <div className="flex flex-col justify-center px-8 sm:px-14 md:px-16 lg:px-20 xl:px-24 py-16 sm:py-20 lg:py-24">
          <div className="w-full max-w-xl mx-auto">
            {/* Centered Title & Underline */}
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-[48px] font-normal tracking-tight text-[#0A0C0C]">
                Why Super Clean
              </h2>
            ...
            <div className="divide-y divide-[#EBEBEB] border-t border-b border-[#EBEBEB]">
              {features.map((item, index) => (
                <div
                  key={index}
                  className="py-6 sm:py-7 flex flex-col sm:flex-row sm:items-start gap-2 sm:gap-8"
                >
                  <span className="w-[180px] sm:w-[200px] shrink-0 text-[13px] sm:text-[14px] font-normal tracking-[0.05em] text-[#0A0C0C] uppercase">
                    {item.label}
                  </span>
        ...
        <div className="relative w-full min-h-[460px] sm:min-h-[560px] lg:min-h-full bg-neutral-900 overflow-hidden">
          <Image
