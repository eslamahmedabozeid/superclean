...
export default function ContactFormInteractive() {
  ...
  return (
    <motion.div
      ...
      className="lg:col-span-7 bg-white border border-[#EBEBEB] p-6 sm:p-8 md:p-10 rounded-[2px] flex flex-col justify-between"
    >
      <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
        ...
        <div className="pt-2">
          <button
            type="submit"
            className="w-full bg-[#0A0C0C] hover:bg-neutral-800 text-white text-[14px] sm:text-[15px] font-normal tracking-[0.03em] py-3.5 sm:py-4 rounded-[2px] transition-colors cursor-pointer text-center hover:shadow-md active:scale-[0.99]"
          >
            Send Message
          </button>
        </div>
